...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'maps', 'ICRA_Masters'),
            [f for f in glob('maps/ICRA_Masters/*') if os.path.isfile(f)]),
    ...
    entry_points={
        'console_scripts': [
            ...
            'particle_filter_fixed = particle_filter.particle_filter_fixed:main'
        ],
    },
)